...
#if YOLOV5_V62
    if (yolov5.load_param("../models/yolov5s_6.2.param"))
        exit(-1);
    if (yolov5.load_model("../models/yolov5s_6.2.bin"))
        exit(-1);
#elif YOLOV5_V60
    if (yolov5.load_param("../models/yolov5s_6.0-opt.param"))
        exit(-1);
    if (yolov5.load_model("../models/yolov5s_6.0-opt.bin"))
        exit(-1);
#else
